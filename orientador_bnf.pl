...
% --- Gastronomía ---
sinonimo(chef,                gastronomia).
sinonimo(chefs,               gastronomia).
sinonimo(cocinero,            gastronomia).
sinonimo(cocinera,            gastronomia).
sinonimo(cocina,             gastronomia).
sinonimo(culinaria,          gastronomia).
sinonimo(reposteria,         gastronomia).
sinonimo(restaurante,        gastronomia).
sinonimo(alta_cocina,       gastronomia).
sinonimo(gestion_restaurante, gastronomia).
sinonimo(alimentacion,      gastronomia).
sinonimo(nutricion,         gastronomia).
sinonimo(servicio,          gastronomia).

% --- Más sinonimos comunes ---
sinonimo(actor,             teatro).
sinonimo(actriz,            teatro).
sinonimo(actuacion,         teatro).
sinonimo(algebra,            algebra).
sinonimo(analisis,           analisis).
sinonimo(analizar,           analisis).
sinonimo(aplicaciones,       software).
sinonimo(apoyar,            apoyo).
sinonimo(apoyo,              apoyo).
sinonimo(aprender,           aprendizaje).
sinonimo(arquitecta,            arquitectura).
sinonimo(arquitecto,           arquitectura).
sinonimo(atleta,            deportivo).
sinonimo(ayuda,              ayudar).
sinonimo(banda,             banda).
sinonimo(bar,                 restauracion).
sinonimo(bateria,           musica).
sinonimo(buena,              bueno).
sinonimo(bueno,               bueno).
sinonimo(calculo,           calculo).
sinonimo(caminos,             infraestructura).
sinonimo(cantar,             musica).
sinonimo(canto,              musica).
sinonimo(ciberseguridad,     redes).
sinonimo(comunicador,       comunicacion).
sinonimo(comunicadora,      comunicacion).
sinonimo(reportero,           comunicacion).
sinonimo(mesero,             servicio).
sinonimo(mesera,             servicio).
sinonimo(estudiar,             estudio).
sinonimo(estudio,             estudio).
sinonimo(campo,             trabajo_campo).
sinonimo(deportivo,           deporte).
sinonimo(deporte,           deporte).
sinonimo(deportista,         deporte).
sinonimo(teatro,            teatro).
sinonimo(actriz,            teatro).
sinonimo(tecnologia_pura,    tecnologia).
sinonimo(ciencias_puras,     ciencias_exactas).
sinonimo(trabajo_fisico,      trabajo_manual).
sinonimo(trabajo_manual,    trabajo_manual).
sinonimo(trabajo_solitario, trabajo_solitario).
sinonimo(trabajo_en_equipo, trabajo_en_equipo).
sinonimo(matematicas_avanzadas, matematicas).
sinonimo(ciencias_exactas,   ciencias_exactas).
sinonimo(humanidades,        humanidades).
sinonimo(oficina,           trabajo_sedentario).
